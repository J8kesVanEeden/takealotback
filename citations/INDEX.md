...
| File | Citation | Court | Retrieved | Status |
|---|---|---|---|---|
...
| [Glaston-House-Inag-1977.md](cases/Glaston-House-Inag-1977.md) | 1977 (2) SA 846 (A) | Appellate Division | 2026-04-24 | 📝 |
| [TRC-Sony-1987.md](cases/TRC-Sony-1987.md) | 1987 (2) SA 994 (A) | Appellate Division | 2026-04-24 | 📝 |
| [Frank-Hirsch-Roopanand-1993.md](cases/Frank-Hirsch-Roopanand-1993.md) | 1993 (4) SA 279 (A) | Appellate Division | 2026-04-24 | 📝 |
...
| File | Body | Retrieved | Status |
|---|---|---|---|
| [cgso-contacts-2026-04-24.md](regulators/cgso-contacts-2026-04-24.md) | Consumer Goods and Services Ombud | 2026-04-24 | ✅ |
| [ncc-contacts-2026-04-24.md](regulators/ncc-contacts-2026-04-24.md) | National Consumer Commission | 2026-04-24 | ✅ |
| [info-regulator-2026-04-24.md](regulators/info-regulator-2026-04-24.md) | Information Regulator | 2026-04-24 | ✅ |
| [arb-2026-04-24.md](regulators/arb-2026-04-24.md) | Advertising Regulatory Board | 2026-04-24 | 📝 |
| [scc-threshold-2026-04-24.md](regulators/scc-threshold-2026-04-24.md) | Small Claims Court (justice.gov.za) | 2026-04-24 | ✅ |
| [nfo-amalgamation-2026-04-24.md](regulators/nfo-amalgamation-2026-04-24.md) | National Financial Ombud Scheme | 2026-04-24 | 📝 |

## Commentary (link-only, `commentary/`)

| File | Publication | Date | Notes |
|---|---|---|---|
| [cliffe-dekker-motus-2021.md](commentary/cliffe-dekker-motus-2021.md) | Cliffe Dekker Hofmeyr | 2021-06-23 | Motus analysis — supports obiter characterisation |
| [moneyweb-naspers-takealot-2018.md](commentary/moneyweb-naspers-takealot-2018.md) | Moneyweb | 2018-06-25 | 96% Naspers ownership |
| [daily-maverick-voltex-2021.md](commentary/daily-maverick-voltex-2021.md) | Daily Maverick | 2021-04-07 | CGSO Voltex ruling explainer |
| [ens-straight-shot-cpa.md](commentary/ens-straight-shot-cpa.md) | ENSafrica | undated | s 69 post-Motus commentary |

---

## How to add a new citation

1. Create a file in the right subfolder, naming by case/Act/publisher + year (kebab-case).
2. Fill in the frontmatter: `title`, `citation`, `court_or_publisher`, `date`, `primary_url`, `retrieved`, `used_in`, `copyright`.
3. Body:
   - **statutes/cases/advisories/policies/regulators** — full verbatim text where copyright allows (see README.md § Copyright policy).
   - **commentary** — short excerpt + link only, never full reproduction.
4. Add a row to the table above in this INDEX.
5. Reference the file path in the commit message of the site change that depends on it.

## How to refresh a citation

1. Open the file.
2. Re-fetch the `primary_url`.
3. If unchanged, bump the `retrieved` date in the frontmatter and commit.
4. If changed, note the diff in a new changelog section at the bottom of the file (do not delete the old snapshot — version the change).
