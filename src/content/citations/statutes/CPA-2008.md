...
## s 60 — Warning concerning fact and nature of risks

s 60(1): Every supplier of goods or services must take reasonable measures to inform consumers of any unusual characteristics, conditions or use of goods that could result in (a) the supplier becoming bound to the consumer for any other obligations; or (b) any risk of an unusual nature or character of which a consumer ought to be aware.

s 60(2): Where the Minister or the National Consumer Commission has reasonable grounds to believe that any goods may be unsafe or pose an unreasonable risk of harm, the Minister or the Commission may direct the supplier to undertake measures to mitigate the risk — including a recall of the goods.

s 60(3): On a recall instruction, the supplier's obligation to take reasonable measures includes, at minimum, ceasing supply of the affected goods and providing affected consumers with a refund or other appropriate remedy.

**Site reliance:** Clause 22 (recall-noncompliance). The s 60 duty is not extinguished by a manufacturer's warranty expiring or by a "12-month warranty period" passing. A recall instruction from the NCC under s 60(2) overrides any private warranty timetable — the consumer is entitled to a refund under the recall, regardless of warranty status. Documented in News24 / Knowler's coverage of the ESR HaloLock power-bank recall (April 2026), where Takealot refused refunds to two consumers on the basis that the manufacturer's 12-month warranty had expired. See `src/content/citations/press/knowler-recall-noncompliance-2026-04-17.md`.
